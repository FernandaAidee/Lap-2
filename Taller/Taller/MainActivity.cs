...
namespace Taller
{
    [Activity(Label = "Taller", MainLauncher = true, Icon = "@drawable/icon")]
    public class MainActivity : Activity
    {
        ...
        public object UploadFromBytea { get; private set; }
        ...
        private async void BtnDatos_Click(object sender, EventArgs e)
        {
            ...
            using (var stream = new MemoryStream())
            {
                ...
                string identificador = string.Format("Fernanda {0}.jpg", Guid.NewGuid().ToString());
        ...
        private void Temporizador_Elapsed(object sender, System.Timers.ElapsedEventArgs e)// el enlasado 
        {
